        ...
        <div id="carouselExample" className="carousel slide" data-bs-ride='carousel'>
          <div className="carousel-inner">
            <div className="carousel-item active" data-bs-interval='100'>
              <img src="/slidermodi.jpg" className="d-block w-100 img-fluid sliderimg" alt="..." />
            </div>
            <div className="carousel-item">
              <img src="/slide0r.jpg" className="d-block w-100 img-fluid sliderimg" alt="..." />
            </div>
            <div className="carousel-item">
              <img src="/slider09.jpg.jpg" className="d-block w-100 img-fluid sliderimg" alt="..." />
            </div>
          </div>
          <button
